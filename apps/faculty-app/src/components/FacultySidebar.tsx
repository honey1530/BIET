...
export const FacultySidebar: React.FC<FacultySidebarProps> = ({
  ...
  const menuSections = [
    ...
    },
    {
      ...
      icon: BookOpen,
      items: [
        { id: 'syllabus', label: 'Syllabus & Unit Coverage', icon: BookOpen },
      ]
    },
    {
      key: 'question_paper',
      ...
      icon: FileText,
      items: [
        { id: 'question_paper', label: 'Bloom\'s Mid Paper Studio', icon: FileText },
      ]
    },
    {
      key: 'ai',
  ...
  return (
    <>
      ...
      <aside className={`fixed md:static top-16 bottom-0 left-0 z-40 w-64 bg-white border-r border-slate-200 text-slate-900 flex flex-col flex-shrink-0 select-none shadow-2xl md:shadow-none transition-transform duration-300 ${
